...
namespace BppLib.BppParser
{
    public static partial class ParserBpp
    {
		...
		public static BGeo ParseBGeo(string code)
		{
			...
			obj.A21 = Convert.ToInt32(values[11]);
			obj.Z = Convert.ToDouble(values[12], CultureInfo.InvariantCulture);
			obj.Tos =(values[13].Trim() == "1");
			obj.Vtr = Convert.ToInt32(values[14]);
			obj.S21 = Convert.ToInt32(values[15]);
			obj.Id = values[16].Trim().Trim('"');
			obj.Azs = Convert.ToDouble(values[17], CultureInfo.InvariantCulture);
			obj.Mac = values[18].Trim().Trim('"');
			obj.Tnm = values[19].Trim().Trim('"');
			obj.Ttp = Convert.ToInt32(values[20]);
			obj.Tcl = Convert.ToInt32(values[21]);
			obj.Rsp = Convert.ToInt32(values[22]);
			obj.Ios = Convert.ToInt32(values[23]);
			obj.Wsp = Convert.ToInt32(values[24]);
			obj.Spi = values[25].Trim().Trim('"');
			obj.Dds = Convert.ToDouble(values[26], CultureInfo.InvariantCulture);
			obj.Dsp = Convert.ToInt32(values[27]);
			obj.Bfc =(values[28].Trim() == "1");
			obj.Shp = Convert.ToInt32(values[29]);
			...
			obj.Rmd =(RmdType)Convert.ToInt32(values[38]);
			obj.Dqt = Convert.ToInt32(values[39]);
			return obj;
		}
