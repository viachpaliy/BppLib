...
namespace BppLib.BppParser
{
    public static partial class ParserBpp
    {
		public static AincAnCe ParseAincAnCe(string code)
		{
			...
			obj.Id = id;
			obj.Xi = Convert.ToDouble(values[0]);
			obj.Yi = Convert.ToDouble(values[1]);
			obj.A = Convert.ToDouble(values[2]);
			obj.Dir =(CircleDirection)Convert.ToInt32(values[3]);
			obj.Zs = Convert.ToDouble(values[4]);
			obj.Ze = Convert.ToDouble(values[5]);
		...
		public static ArcAnCe ParseArcAnCe(string code)
		{
			...
			obj.Id = id;
			obj.A = Convert.ToDouble(values[0]);
			obj.Xc = Convert.ToDouble(values[1]);
			obj.Yc = Convert.ToDouble(values[2]);
			obj.Dir =(CircleDirection)Convert.ToInt32(values[3]);
			obj.Zs = Convert.ToDouble(values[4]);
			obj.Ze = Convert.ToDouble(values[5]);
			obj.Sc =(SharpCorner)Convert.ToInt32(values[6]);
		...
		public static ArcAnCeRaTp ParseArcAnCeRaTp(string code)
		{
			...
			obj.Xc = Convert.ToDouble(values[1]);
			obj.Yc = Convert.ToDouble(values[2]);
			obj.R = Convert.ToDouble(values[3]);
		...
		public static ArcCeTs ParseArcCeTs(string code)
		{
			...
			obj.Zs = Convert.ToDouble(values[3]);
			obj.Ze = Convert.ToDouble(values[4]);
		...
		public static ArcEpCe ParseArcEpCe(string code)
		{
			...
			obj.Id = id;
			obj.Xe = Convert.ToDouble(values[0]);
			obj.Ye = Convert.ToDouble(values[1]);
			obj.Xc = Convert.ToDouble(values[2]);
			obj.Yc = Convert.ToDouble(values[3]);
			obj.Dir =(CircleDirection)Convert.ToInt32(values[4]);
			obj.Zs = Convert.ToDouble(values[5]);
			obj.Ze = Convert.ToDouble(values[6]);
			obj.Sc =(SharpCorner)Convert.ToInt32(values[7]);
		...
		public static ArcIpEp ParseArcIpEp(string code)
		{
			...
			obj.Id = id;
			obj.X2 = Convert.ToDouble(values[0]);
			obj.Y2 = Convert.ToDouble(values[1]);
			obj.Xe = Convert.ToDouble(values[2]);
			obj.Ye = Convert.ToDouble(values[3]);
			obj.Zs = Convert.ToDouble(values[4]);
			obj.Ze = Convert.ToDouble(values[5]);
			obj.Sc =(SharpCorner)Convert.ToInt32(values[6]);
			obj.Fd = Convert.ToInt32(values[7]);
		...
		public static ArcRaTs ParseArcRaTs(string code)
		{
			...
			obj.Id = id;
			obj.R = Convert.ToDouble(values[0]);
			obj.Dir =(CircleDirection)Convert.ToInt32(values[1]);
			obj.Zs = Convert.ToDouble(values[2]);
			obj.Ze = Convert.ToDouble(values[3]);
		...
		public static ConnectorA ParseConnectorA(string code)
		{
			...
			obj.Id = id;
			obj.R = Convert.ToDouble(values[0]);
			obj.Zs = Convert.ToDouble(values[1]);
			obj.Ze = Convert.ToDouble(values[2]);
