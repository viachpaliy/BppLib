...
namespace BppLib.Core
{
	...
	public class Circle3P: IBppCode
	{
		...
		public string AsBppCode()
		{
			...
			sb.Append(",");
			sb.Append(" " + X3.ToString(CultureInfo.InvariantCulture));
			sb.Append(",");
			sb.Append(" " + Y3.ToString(CultureInfo.InvariantCulture));
			sb.Append(",");
		...
		public string AsCixCode()
		{
			...
			sb.AppendLine("	PARAM,NAME=X3,VALUE=" + X3.ToString(CultureInfo.InvariantCulture));
			sb.AppendLine("	PARAM,NAME=Y3,VALUE=" + Y3.ToString(CultureInfo.InvariantCulture));
