...
namespace BppLib.Core
{
	...
	public class Star: IBppCode
	{
		...
		public string AsBppCode()
		{
			...
			sb.Append(",");
			sb.Append(" " + Er.ToString().Replace(',','.'));
			sb.Append(",");
			sb.Append(" " + Ir.ToString().Replace(',','.'));
			sb.Append(",");
		...
		public string AsCixCode()
		{
			...
			sb.AppendLine("	PARAM,NAME=ER,VALUE=" + Er.ToString().Replace(',','.'));
			sb.AppendLine("	PARAM,NAME=IR,VALUE=" + Ir.ToString().Replace(',','.'));
