...
namespace BppLib.Core
{
	...
	public class Oval: IBppCode
	{
		...
		public string AsBppCode()
		{
			...
			sb.Append(",");
			sb.Append(" " + R1.ToString().Replace(",","."));
			sb.Append(",");
			sb.Append(" " + X2.ToString().Replace(",","."));
			sb.Append(",");
			sb.Append(" " + Y2.ToString().Replace(",","."));
			sb.Append(",");
			sb.Append(" " + R2.ToString().Replace(",","."));
			sb.Append(",");
			sb.Append(" " + Lkr.ToString().Replace(",","."));
			sb.Append(",");
		...
		public string AsCixCode()
		{
			...
			sb.AppendLine("	PARAM,NAME=R1,VALUE=" + R1.ToString().Replace(",","."));
			sb.AppendLine("	PARAM,NAME=X2,VALUE=" + X2.ToString().Replace(",","."));
			sb.AppendLine("	PARAM,NAME=Y2,VALUE=" + Y2.ToString().Replace(",","."));
			sb.AppendLine("	PARAM,NAME=R2,VALUE=" + R2.ToString().Replace(",","."));
			sb.AppendLine("	PARAM,NAME=LKR,VALUE=" + Lkr.ToString().Replace(",","."));
