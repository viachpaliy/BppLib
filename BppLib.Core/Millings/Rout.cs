...
{
    /// <summary>Class <c>Rout</c> models the milling operation using an “integrated” geometric profile.</summary>
	public class Rout: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "ROUT" ;
        ...
        /// <value>Property <c>Dx</c> represents the distance between centres along the X-axis
        /// that defines the distance between the repetitions of the milling.</value>
		public double Dx { get; set; } = 32 ;

        /// <value>Property <c>Dy</c> represents the distance between centres along the Y-axis
        /// that defines the distance between the repetitions of the milling.</value>
		...
		public string Lay { get; set; } = "ROUT" ;
		...
		public string AsBppCode()
		{
			...
			sb.Append(",");
			sb.Append(" " + ConvertBoolToNum(Rdl));
			sb.Append(",");
