...
namespace BppLib.Core
{
	...
	public class Bg: IBppCode
	{
		...
		/// <value>Property <c>Rmd</c> models the "RMD" parameter of the "BG" macro.
		...
		public string AsBppCode()
		{
			...
			if (Cow)
				...
				{sb.Append(" 0");}
			sb.Append(",");
			sb.Append(" " + A21.ToString(CultureInfo.InvariantCulture));
			sb.Append(",");
			if (Tos)
				{sb.Append(" 1");}
			else
				{sb.Append(" 0");}
			sb.Append(",");
			sb.Append(" " + Vtr.ToString(CultureInfo.InvariantCulture));
			sb.Append(",");
			sb.Append(" " + S21.ToString(CultureInfo.InvariantCulture));
			sb.Append(",");
			sb.Append(" \"" + Id +"\"");
			sb.Append(",");
			...
			if (Dtas)
				...
				{sb.Append(" 0");}
			sb.Append(",");
			sb.Append(" " + ((int)Rmd).ToString(CultureInfo.InvariantCulture));
			sb.Append(",");
			sb.Append(" " + Dqt.ToString(CultureInfo.InvariantCulture));
			sb.Append(",");
			if (Erdw)
				{sb.Append(" 1");}
			else
				{sb.Append(" 0");}
			sb.Append(",");
			sb.Append(" " + Dfw.ToString(CultureInfo.InvariantCulture));
			return sb.ToString();
		}
		...
		public string AsCixCode()
		{
			...
			sb.AppendLine("	PARAM,NAME=NRP,VALUE=" + Nrp.ToString(CultureInfo.InvariantCulture));
			...
			sb.AppendLine("	PARAM,NAME=A21,VALUE=" + A21.ToString(CultureInfo.InvariantCulture));
			if (Tos)
				{sb.AppendLine("	PARAM,NAME=TOS,VALUE=YES");}
			else
				{sb.AppendLine("	PARAM,NAME=TOS,VALUE=NO");}
			sb.AppendLine("	PARAM,NAME=VTR,VALUE=" + Vtr.ToString(CultureInfo.InvariantCulture));
			sb.AppendLine("	PARAM,NAME=S21,VALUE=" + S21.ToString(CultureInfo.InvariantCulture));
			...
			sb.AppendLine("	PARAM,NAME=SHP,VALUE=" + Shp.ToString(CultureInfo.InvariantCulture));
			if (Ea21)
			...
			sb.AppendLine("	PARAM,NAME=DFW,VALUE=" + Dfw.ToString(CultureInfo.InvariantCulture));
			sb.Append("END MACRO");
			return sb.ToString();
		}
