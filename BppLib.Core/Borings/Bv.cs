...
{
    /// <summary>Class <c>Bv</c> models the boring operation using the vertical spindle.</summary> 
	public class Bv: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "BV" ;
		...
		/// <value>Property <c>Rmd</c> models the "RMD" parameter of the "BV" macro.
		...
		/// <value>Property <c>Dqt</c> models the "DQT" parameter of the "BV" macro.
		/// The exact meaning of the parameter is unknown. Default value is 0.</value>
		public int Dqt { get; set; } = 0 ;

		/// <value>Property <c>Erdw</c> models the "ERDW" parameter of the "BV" macro.
		/// The exact meaning of the parameter is unknown. Default value is false("NO").</value>
		public bool Erdw { get; set; } = false ;

		/// <value>Property <c>Dfw</c> models the "DFW" parameter of the "BV" macro.
		/// The exact meaning of the parameter is unknown. Default value is 0.</value>
		public int Dfw { get; set; } = 0 ;

		/// <summary>This constructor initializes the new Bv
