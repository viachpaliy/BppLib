...
{
    /// <summary>Class <c>ConnectorA</c> models the connection radius
    ///  between the selected element and the preceding one (of type A).
    /// </summary>
	public class ConnectorA: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "CONNECTOR" ;
        ...
        /// <summary>This constructor initializes the new ConnectorA
