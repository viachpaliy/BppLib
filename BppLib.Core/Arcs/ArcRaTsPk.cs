...
{
    /// <summary>Class <c>ArcRaTsPk</c> models the curve given radius 
    /// and tangency to next element(with previous point not determined).
    /// Creates an arc with an unknown start point, using the radius of the arc and the tangency of the arc to
    /// the following element as reference values.
    /// </summary>
	public class ArcRaTsPk: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "ARC_RATSPK" ;
        ...
        /// <summary>This constructor initializes the new ArcRaTsPk
