...
{
    /// <summary>Class <c>ArcCeTsPk</c> models the curve given centre and tangency to next element 
    ///(with previous point not determined).
    ...
    /// </summary>
    public class ArcCeTsPk: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "ARC_CETSPK" ;
        ...
        /// <summary>This constructor initializes the new ArcCeTsPk
