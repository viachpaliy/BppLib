...
{
    /// <summary>Class <c>ConnectorB</c> models the connection radius
    /// that can be used to machine door and window frames (of type B).
    /// </summary>
	public class ConnectorB: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "CONNECTOR2" ;

		/// <value>Property <c>Id</c> represents the unique identifier an object of BiesseWorks.</value>
		public int Id { get; set; } 

        /// <value>Property <c>R</c> represents connection radius value.</value>
        ...
        /// <summary>This constructor initializes the new ConnectorB
