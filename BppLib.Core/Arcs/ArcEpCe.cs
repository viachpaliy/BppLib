...
{
    /// <summary>Class <c>ArcEpCe</c> models the curve given end point and centre. 
    /// Creates an arc using the co-ordinates of the centre of the
    /// arc and the co-ordinates of a known endpoint as reference values.
    /// </summary>
	public class ArcEpCe: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "ARC_EPCE" ;
        ...
        /// <summary>This constructor initializes the new ArcEpCe
