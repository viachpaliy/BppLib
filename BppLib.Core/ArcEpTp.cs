...
{
    /// <summary>Class <c>ArcEpTp</c> models the curve given end point and tangency to previous item.
    /// Creates an arc using the co-ordinates of the endpoint of the arc 
    /// and the tangency to the preceding element as reference values.
    /// </summary>
	public class ArcEpTp: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "ARC_EPTP" ;
        ...
        /// <summary>This constructor initializes the new ArcEpTp
