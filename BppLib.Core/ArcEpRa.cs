...
{
    /// <summary>Class <c>ArcEpRa</c> models the curve given end point and radius.
    /// Creates an arc using the radius of the arc and the coordinates of the endpoint of the arc as reference values.
    /// </summary>
	public class ArcEpRa: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "ARC_EPRA" ;
        ...
        /// <summary>This constructor initializes the new ArcEpRa
