...
namespace BppLib.Core
{
    ...
    public class MainDataSection : IBppCode
    {
		...
		public string AsCixCode()
		{
            ...
            sb.AppendLine("\tLPX=" + Lpx.ToString());
	        sb.AppendLine("\tLPY=" + Lpy.ToString());
	        sb.AppendLine("\tLPZ=" + Lpz.ToString());
	        sb.AppendLine("\tORLST=\"" +  OrLst + "\"");
	        sb.AppendLine("\tSIMMETRY=" + ConvBoolToInt(Simmetry));
	        sb.AppendLine("\tTLCHK=" + TlChk.ToString());
	        ...
	        sb.AppendLine("\tXCUT=" + XCut.ToString());
	        sb.AppendLine("\tYCUT=" + YCut.ToString());
	        sb.AppendLine("\tJIGTH=" + JigTh.ToString());
	        sb.AppendLine("\tCKOP=" + Ckop.ToString());
	        sb.AppendLine("\tUNIQUE=" + ConvBoolToInt(Unique));
	        sb.AppendLine("\tMATERIAL=\"" + Material + "\"");
	        sb.AppendLine("\tPUTLST=\"" + PutLst + "\""); 
	        sb.AppendLine("\tOPPWKRS=" + Oppwkrs.ToString());
	        sb.AppendLine("\tUNICLAMP=" + ConvBoolToInt(UniClamp));
	        sb.AppendLine("\tCHKCOLL=" + ConvBoolToInt(ChkColl));
	        sb.AppendLine("\tWTPIANI=" + WtPiani.ToString()); 
	        sb.AppendLine("\tCOLLTOOL=" + CollTool.ToString());
	        sb.AppendLine("\tCALCEDTH=" + CalcEdTh.ToString());
	        sb.AppendLine("\tENABLELABEL=" + ConvBoolToInt(EnableLabel));
	        sb.AppendLine("\tLOCKWASTE=" + ConvBoolToInt(LockWaste));
	        sb.AppendLine("\tLOADEDGEOPT=" + LoadEdgeOpt.ToString());
	        sb.AppendLine("\tITLTYPE=" + ItlType.ToString());
	        sb.AppendLine("\tRUNPAV=" + ConvBoolToInt(RunPav));
	        sb.AppendLine("\tFLIPEND=" + FlipEnd.ToString());
	        ...
	        sb.AppendLine("\tFASTVERTBORINGSVALUE=" + FastVertBoringsValue.ToString());
