...
namespace BppLib.Core
{
    ...
    public class MainDataSection : IBppCode
    {
		...
		public string AsBppCode()
		{
            ...
            sb.AppendLine("PAN=XCUT|" + XCut.ToString() + "||4|");
            sb.AppendLine("PAN=YCUT|" + YCut.ToString() + "||4|");
            sb.AppendLine("PAN=JIGTH|" + JigTh.ToString() + "||4|");
		...
		public string AsCixCode()
		{
            ...
            sb.AppendLine("\tLPX=" + Lpx.ToString().Replace(",","."));
	        sb.AppendLine("\tLPY=" + Lpy.ToString().Replace(",","."));
	        sb.AppendLine("\tLPZ=" + Lpz.ToString().Replace(",","."));
	        sb.AppendLine("\tORLST=\"" +  OrLst + "\"");
	        sb.AppendLine("\tSIMMETRY=" + ConvBoolToInt(Simmetry));
	        sb.AppendLine("\tTLCHK=" + TlChk.ToString().Replace(",","."));
	        ...
	        sb.AppendLine("\tXCUT=" + XCut.ToString().Replace(",","."));
	        sb.AppendLine("\tYCUT=" + YCut.ToString().Replace(",","."));
	        sb.AppendLine("\tJIGTH=" + JigTh.ToString().Replace(",","."));
	        sb.AppendLine("\tCKOP=" + Ckop.ToString().Replace(",","."));
	        sb.AppendLine("\tUNIQUE=" + ConvBoolToInt(Unique));
	        sb.AppendLine("\tMATERIAL=\"" + Material + "\"");
	        sb.AppendLine("\tPUTLST=\"" + PutLst + "\""); 
	        sb.AppendLine("\tOPPWKRS=" + Oppwkrs.ToString().Replace(",","."));
	        sb.AppendLine("\tUNICLAMP=" + ConvBoolToInt(UniClamp));
	        sb.AppendLine("\tCHKCOLL=" + ConvBoolToInt(ChkColl));
	        sb.AppendLine("\tWTPIANI=" + WtPiani.ToString().Replace(",",".")); 
	        sb.AppendLine("\tCOLLTOOL=" + CollTool.ToString().Replace(",","."));
	        sb.AppendLine("\tCALCEDTH=" + CalcEdTh.ToString().Replace(",","."));
	        sb.AppendLine("\tENABLELABEL=" + ConvBoolToInt(EnableLabel));
	        sb.AppendLine("\tLOCKWASTE=" + ConvBoolToInt(LockWaste));
	        sb.AppendLine("\tLOADEDGEOPT=" + LoadEdgeOpt.ToString().Replace(",","."));
	        sb.AppendLine("\tITLTYPE=" + ItlType.ToString().Replace(",","."));
	        sb.AppendLine("\tRUNPAV=" + ConvBoolToInt(RunPav));
	        sb.AppendLine("\tFLIPEND=" + FlipEnd.ToString().Replace(",","."));
	        ...
	        sb.AppendLine("\tFASTVERTBORINGSVALUE=" + FastVertBoringsValue.ToString().Replace(",","."));
