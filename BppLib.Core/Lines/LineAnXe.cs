...
{
    /// <summary>Class <c>LineAnXe</c> models the line given angle and final X.
    /// Creates a line using the X co-ordinate of the endpoint and the
    /// angle with respect to the positive direction of the X-axis as reference values.</summary>
	public class LineAnXe: IBppCode
	{
        /// <value>Property <c>BppName</c> represents the name of BiesseWorks type.</value>
		public string BppName { get; } = "LINE_ANXE" ;
